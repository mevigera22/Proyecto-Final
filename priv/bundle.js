...
var grammar = {
    ...
    {"name": "condicional_si", "symbols": [{"literal":"si no"}, "_", {"literal":"("}, "_", "comparacion", "_", {"literal":")"}, "_", {"literal":"{"}, "_", (lexer.has("NL") ? {type: "NL"} : NL), "statements", (lexer.has("NL") ? {type: "NL"} : NL), "_", {"literal":"}"}, {"literal":"sino"}, {"literal":"{"}, "_", "statements", "_", {"literal":"}"}], "postprocess":  
        (d) => {
            return {
